...
import { ArrowLeft, CollectionTag, DocumentAdd, List, MagicStick, Moon, PriceTag, Sunny, SwitchButton, User } from '@element-plus/icons-vue'
...
const menuItems = [
  ...
  { path: '/admin/ai', label: 'AI 设置', icon: MagicStick },
]
